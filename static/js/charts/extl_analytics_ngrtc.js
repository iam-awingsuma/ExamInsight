// js/charts/extl_analytics_ngrtc.js
...
(() => {
  ...
  async function renderStanineThresholdPie({
    ...
    try {
      ...
      const trace = {
        ...
        marker: {
            colors: ['#FFAAAA', '#FFDEB9'] // Custom colors for better distinction
        },
        hovertemplate:
            "<b>%{label}</b><br>" +
            "Students: %{value}<br>" +
  ...
  async function renderYearGroupStanine5GenderBars({
    ...
    try {
      ...
      renderGenderYearGroupTable("tbl-yrgrp-male-st5-extl-ngrtc", male);

      renderGraph(elIdFemale, female);
      renderGenderYearGroupTable("tbl-yrgrp-female-st5-extl-ngrtc", female);
    }
  ...
  async function renderYearGroupStanine6GenderBars({
    ...
    try {
      ...
      // --------- Render Table & Graphs ---------
      renderGraph(elIdMale, male);
      renderGenderYearGroupTable("tbl-yrgrp-male-st6-extl-ngrtc", male);

      renderGraph(elIdFemale, female);
      renderGenderYearGroupTable("tbl-yrgrp-female-st6-extl-ngrtc", female);
    }
  ...
  async function renderYearGroupGenderProgressThresholdBars({
    ...
    try {
      ...
      renderTable("tbl-male-ebp-extl-ngrtc", male.totals, male.meetsEBP);
      renderTable("tbl-female-ebp-extl-ngrtc", female.totals, female.meetsEBP);
      ...
      renderTable("tbl-male-bp-extl-ngrtc", male.totals, male.meetsBP);
      renderTable("tbl-female-bp-extl-ngrtc", female.totals, female.meetsBP);
    }
    // Error handler
    catch(err){
      console.error("Progress category error:", err);
  ...
  document.addEventListener("shown.bs.tab", function () {
    [
      ...
      "bar-male-ebp-extl-ngrtc", "bar-female-ebp-extl-ngrtc",
      "bar-male-bp-extl-ngrtc", "bar-female-bp-extl-ngrtc",
    ].forEach(function(id){
  ...
  window.renderStanine6Pie = function (elId = "pie-st6-extl-ngrtc") {
    return renderStanineThresholdPie({
      elId,
      datasetKey: "ngrtc",
      stanineKey: "stanine",
  ...
  window.renderGenderStanine5Bar = function (elId = "bar-gender-st5-extl-ngrtc") {
  ...
  window.renderGenderStanine6Bar = function (elId = "bar-gender-st6-extl-ngrtc") {
    return renderGenderStanineThresholdBar({
      elId,
      datasetKey: "ngrtc",
      stanineKey: "stanine",
  ...
  window.renderYearGroupStanine5GenderBars = function () {
    return renderYearGroupStanine5GenderBars({
      elIdMale: "bar-yrgrp-male-st5-extl-ngrtc",
      elIdFemale: "bar-yrgrp-female-st5-extl-ngrtc"
    });
  }

  window.renderYearGroupStanine6GenderBars = function () {
    return renderYearGroupStanine6GenderBars({
      elIdMale: "bar-yrgrp-male-st6-extl-ngrtc",
      elIdFemale: "bar-yrgrp-female-st6-extl-ngrtc"
    });
  }
  ...
  window.renderYearGroupGenderProgressBars = function (){
    return renderYearGroupGenderProgressThresholdBars({
      elIdMaleEBP: "bar-male-ebp-extl-ngrtc", elIdFemaleEBP: "bar-female-ebp-extl-ngrtc",
      elIdMaleBP: "bar-male-bp-extl-ngrtc", elIdFemaleBP: "bar-female-bp-extl-ngrtc"
    });
  };
