...
(() => {
  ...
  async function renderStanineThresholdPie({
    ...
    try {
      ...
      const trace = {
        ...
        marker: {
            colors: ['#EA7B7B', '#FFDEB9'] // Custom colors for better distinction
        },
        hovertemplate:
            "<b>%{label}</b><br>" +
            "Students: %{value}<br>" +
  ...
  function wireResize() {
    window.addEventListener("resize", () => {
      const el5 = document.getElementById("pie-st5-extl-ngrtc");
      const el6 = document.getElementById("pie-st6-extl-ngrtc");
